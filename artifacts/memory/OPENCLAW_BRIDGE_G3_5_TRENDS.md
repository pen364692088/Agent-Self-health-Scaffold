# OpenClaw Bridge G3.5: Trend Tracking
...
追踪 G3 limited mainline assist 在观察期内的趋势变化。
...
| Day | Requests | Allowed | Denied | Suggestions | Adoptions | Errors |
|-----|----------|---------|--------|-------------|-----------|--------|
| Mon | - | - | - | - | - | - |
| Tue | - | - | - | - | - | - |
| Wed | - | - | - | - | - | - |
...
| Task Type | Allowed | Requests | Adoption Rate |
|-----------|---------|----------|---------------|
| coding | Yes | - | - |
| decision | Yes | - | - |
| question | Yes | - | - |
...
- [ ] Adoption rate stable or improving
- [ ] Noise rate stable or decreasing
- [ ] Error rate stable or decreasing
- [ ] Main chain success rate maintained
...
- [ ] Main chain success rate declining
...
- [ ] Fail-open triggered frequently
...
Recommendation: Continue observation (need more data)

### After W2

Recommendation: TBD based on full data
